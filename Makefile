...
# user_drivers/Anne/Makefile.  Generated from Makefile.in by configure.
...
am__relativize = \
  ...
  reldir="$$dir2"
ACLOCAL = ${SHELL} /zhome/59/2/70586/version_anne/trunk/missing --run aclocal-1.11
AMTAR = ${SHELL} /zhome/59/2/70586/version_anne/trunk/missing --run tar
...
AM_LDFLAGS = 
AR = ar
AUTOCONF = ${SHELL} /zhome/59/2/70586/version_anne/trunk/missing --run autoconf
AUTOHEADER = ${SHELL} /zhome/59/2/70586/version_anne/trunk/missing --run autoheader
AUTOMAKE = ${SHELL} /zhome/59/2/70586/version_anne/trunk/missing --run automake-1.11
AWK = gawk
BLACS_LIB = 
BLAS_LIB = 
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /zhome/59/2/70586/version_anne/trunk/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
...
PACKAGE_STRING = oomph-lib 1.0.1280
PACKAGE_TARNAME = oomph-lib
PACKAGE_VERSION = 1.0.1280
PATH_SEPARATOR = :
PORD_LIB = 
PRIVATE_DIR = 
...
TRILINOS_INCLUDE = 
TRILINOS_LIB = 
USER_DRIVERS_SUBDIRECTORIES = Anne/ jack_cool/ joe_cool/
USER_SRC_SUBDIRECTORIES = jack_cool/
VERSION = 1.0.1280
abs_builddir = /zhome/59/2/70586/version_anne/trunk/user_drivers/Anne
abs_srcdir = /zhome/59/2/70586/version_anne/trunk/user_drivers/Anne
abs_top_builddir = /zhome/59/2/70586/version_anne/trunk
abs_top_srcdir = /zhome/59/2/70586/version_anne/trunk
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
ac_ct_F77 = gfortran
...
install_sh = ${SHELL} /zhome/59/2/70586/version_anne/trunk/install-sh
...
pdfdir = ${docdir}
prefix = /zhome/59/2/70586/version_anne/trunk/build
...
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am  $(am__configure_deps)
	...
	echo ' cd $(top_srcdir) && $(AUTOMAKE) --foreign user_drivers/Anne/Makefile'; \
	$(am__cd) $(top_srcdir) && \
	  $(AUTOMAKE) --foreign user_drivers/Anne/Makefile
.PRECIOUS: Makefile
